<template>
  <view class="custom-tabbar">
    ...
    <view class="play-btn-wrapper" @click="goToPlayer">
      <view class="play-btn">
        <image v-if="currentContent && currentContent.coverUrl" :src="currentContent.coverUrl" class="play-cover" mode="aspectFill" />
        <image v-else src="/static/icons/play.svg" class="play-icon" mode="aspectFit" />
      </view>
    </view>
    <!-- 音乐库Tab -->
